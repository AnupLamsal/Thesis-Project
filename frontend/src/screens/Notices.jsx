        ...
        <div className="container">
          <div className="row d-flex align-items-center py-5">
            ...
            <div className="col-lg-6 text-start">
              <h1 className="py-5 text-primary typo-space-line">
                Events and Notices
              </h1>
              ...
              <p className="text-muted">
                ...
                <a rel="noreferrer" href="http://Anup.com/" target="_blank">
                  Anup
                </a>{" "}
                website.
              </p>
        ...
        <div className="container py-5">
          <div className="row d-flex justify-content-center text-center">
            ...
            <div className="col-lg-7 col-12 text-light pt-2">
              ...
              <p className="light-300">
                Get ready to transform yourself from zero to hero with our
                courses
                <br />
                <a
                  rel="noreferrer"
                  target="_blank"
                  href="https://www.Anup.com/vectors/mockup"
                >
                  Mockup vector created by macrovector - www.Anup.com
                </a>
              </p>
            </div>
          ...
          <div className="row gy-5 g-lg-5 mb-4">
            <div className="col-md-4 mb-3">
              <NavLink
                to="/"
                exact
                className="features card border-0 shadow-lg overflow-hidden"
              >
                <img
                  className="features-img card-img"
                  src={bck}
                  alt="eventImage"
                />
